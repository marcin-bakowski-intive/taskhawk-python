...
from taskhawk import Message, ValidationError, LoggingException, RetryException, IgnoreException, Priority
from taskhawk.backends import base
from taskhawk.backends.aws import AwsSQSConsumerBackend, AwsSQSPublisherBackend
from taskhawk.backends.base import get_consumer_backend, get_publisher_backend, TaskhawkBaseBackend
...
class TestBackends:
    ...
    def test_success_get_publisher_backend(self, mock_boto3, settings):
        ...
        assert isinstance(consumer_backend, AwsSQSPublisherBackend)
